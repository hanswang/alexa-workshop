...
This is a sample template for FactSkillSet - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name factskillset --tail
```
...
```bash
aws cloudformation delete-stack --stack-name factskillset
```
